...
class TestMissedLID:
    ...
    def test_getAutoDebitFailAndgetDemandLetter(self):
        # Auto-debit failed
        response = requests.get(
            "https://lendittfinserve.com/prod/admin/emi/repaymentStatus?fromDate=2023-09-21T10:00:00.000Z&endDate=2023-09-21T10:00:00.000Z&type=TOTAL&page=1&download=true") #previous date
        ...
        response2 = requests.get(
            "https://lendittfinserve.com/prod/admin/legal/getAllLegalData?page=1&startDate=2023-09-22T10%3A00%3A00.000Z&endDate=2023-09-22T10%3A00%3A00.000Z&type=1&adminId=65&download=true",
