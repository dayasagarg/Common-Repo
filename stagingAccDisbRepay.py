...
class TestAccount:
    ...
    def url(self):
        ...
        response1 = requests.get(
            "https://lendittfinserve.com/stag/admin/tally/getAllDisbursementDetails?startDate=2023-10-05T10:00:00.000Z&endDate=2023-10-05T10:00:00.000Z")  # Current date

        ##REPAYMENT SUMMARY
        response2 = requests.get(
            "https://lendittfinserve.com/stag/admin/tally/getAllRepaymentData?startDate=2023-10-05T10:00:00.000Z&endDate=2023-10-05T10:00:00.000Z")  #current date

        # AllDisbursedLoans
        response5 = requests.get(
            "https://lendittfinserve.com/stag/admin/dashboard/allDisbursedLoans?start_date=2023-10-05T10%3A00%3A00.000Z&end_date=2023-10-05T10%3A00%3A00.000Z&page=1&download=true")  #current date


       # AllRepaidLoans
        response4 = requests.get(
            "https://lendittfinserve.com/stag/admin/transaction/allRepaidLoans?start_date=2023-10-05T10:00:00.000Z&end_date=2023-10-05T10:00:00.000Z&page=1&pagesize=10&getTotal=true&download=true")  #current date
    ...
    def test_getDisbSummaryTotalAmtCred(self,url):
        ...
        if (round(cTBTotalCreditFloat) + round(disbAmtTOBorrFloat)) == round(totalAmountCreditFloat):
            ...
            print("Error::Addition of cTBTotalCreditFloat and disbAmtTOBorrFloat not matched with totalAmountCreditFloat")
