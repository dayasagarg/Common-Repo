...
class TestDashRepo:
    ...
    def test_keyFactStatement(self, setup_teardown):
        ...
        if approvedAmount in firstPage:
            ...
            print(f"Error :: 'approvedAmount' :'{approvedAmount}' is not matched with LOAN DETAILS in first Page of pdf ")
        ...
        if loanIntPerAnnumStr in firstPage:
            ...
            print(f"Error :: 'loanIntPerAnnumStr' :'{loanIntPerAnnumStr}%'  is not matched with LOAN DETAILS in first Page of pdf ")
        ...
        try:
            ...
            if processChargeRs in firstPage:
                ...
                print(f"Error :: 'processChargeRs' :'{processChargeRs}' is not matched with CHARGES Section in first Page of pdf ")
        ...
        if documentCharges in firstPage:
            ...
            print(f"Error :: 'documentCharges' :'{documentCharges}' is not matched with CHARGES Section in first Page of pdf ")
        ...
        try:
            if sgst in firstPage:
                ...
                print(f"Exception :: 'sgst' :'{sgst}' is not matched with CHARGES Section in first Page of pdf ")

            assert sgst in firstPage, "sgst is matched with CHARGES Section in first Page of pdf"
            ...
            assert sgst2 in firstPage, "sgst2 is matched with CHARGES Section in first Page of pdf"
        ...
        try:
            if cgst in firstPage:
                ...
                print(f"Exception :: 'cgst' :'{cgst}' is not matched with CHARGES Section in first Page of pdf ")

            assert cgst in firstPage, "cgst is matched with CHARGES Section in first Page of pdf"
            ...
            assert cgst2 in firstPage, "cgst2 is matched with CHARGES Section in first Page of pdf"
        ...
        try:
            ...
            if latePaymentChargePerAnnualString2 in firstPage:
                ...
                print(
                    f"Error :: 'latePaymentChargePerAnnualString2' :'{latePaymentChargePerAnnualString2}' is not matched with CHARGES Section in first Page of pdf ")
        ...
        if stampChargeString2 in thirdPage:
            ...
            print(f"Error :: 'stampChargeString2' :'{stampChargeString2}' is not matched with LETTER OF SANCTION TO THE BORROWER Section in third page of pdf ")
        ...
        try:
            ...
            if penalInterestPerAnnum2 in fourthPage:
                ...
                print(
                    f"Error :: 'penalInterestPerAnnum2' :'{penalInterestPerAnnum2}' is not matched with SECURITY DOCUMENTS section in fourth Page of pdf ")
        ...
        if loanAmountstr in sixthPage:
            ...
            print(f"Error :: 'loanAmountstr' :'{loanAmountstr}' is not matched with LOAN AGREEMENT in sixth Page of pdf ")
        ...
        if loanIntPerAnnumStr in sixthPage:
            print(f" *** 'loanIntPerAnnumStr' :'{loanIntPerAnnumStr}%' is matched with LOAN AGREEMENT in sixth Page of pdf *** ")
        else:
            print(f"Error :: 'loanIntPerAnnumStr' :'{loanIntPerAnnumStr}' is not matched with LOAN AGREEMENT in sixth Page of pdf ")

        assert loanIntPerAnnumStr in sixthPage, "loanIntPerAnnumStr is matched with LOAN AGREEMENT in sixth Page of pdf"
        ...
        try:
            ...
            if latePaymentChargePerAnnualString2 in sixthPage:
                ...
                print(
                    f"Error :: 'latePaymentChargePerAnnualString2' :'{latePaymentChargePerAnnualString2}' is not matched with LOAN AGREEMENT in sixth Page of pdf ")
